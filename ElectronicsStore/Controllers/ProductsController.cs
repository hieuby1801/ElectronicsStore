...
namespace ElectronicsStore.Controllers
{
	public class ProductsController : Controller
    {
        ...
        public ProductsController(DbMSContextNew context)
        {
            _context = context;
        }
        ...
        {
            var dbMSContextNew = _context.Products.Include(p => p.IdCategoryNavigation);
        ...
        //public async Task<IActionResult> Create([Bind("IdProduct,Name,Price,IdCategory,Image")] Product product)
